...
|--------------------|-----------------------|-------------------------------------|-------------------------------------------------------------|----------------------   |
| US01               | Registrar turista     | Como turista, quiero poder registrarme en la plataforma para acceder a todas las funcionalidades y servicios disponibles         | ESCENARIO 1: Registro exitoso como turista | **ESCENARIO**: Registro exitoso como turista                        **Dado que** el turista desea registrarse en la plataforma web                       **Cuando** el turista ingrese sus datos correctamente en la sección de registro para turistas    **Y** de clic en “registrar”                                              **Entonces** el turista se registrará de forma exitosa | 01
